...
LABEL org.opencontainers.image.url=https://github.com/NekoSuneVR/synapse-admin org.opencontainers.image.source=https://github.com/NekoSuneVR/synapse-admin
